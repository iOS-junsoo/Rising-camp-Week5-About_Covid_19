...
class firstViewController: UIViewController, XMLParserDelegate {
    ...
    override func viewDidLoad() {
        ...
        let current_date_string1 = formatter1.string(from: Date())
        ...
        let strings = ["오늘(\(current_date_string1))까지의 총 확진자 수는 \(total1)명 입니다. 전일 대비 확진자 수가 총 \(total2)명이 증가하였으니 개인 소독에 집중하는 하루되시길 바랍니다."]
